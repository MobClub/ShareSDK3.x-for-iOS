...
- (void)showShareEditor
{
    ...
    if (imageArray) {
        ...
        NSMutableDictionary *shareParams = [NSMutableDictionary dictionary];
        [shareParams SSDKSetupShareParamsByText:@"http://www.mob.com/"
                                         images:imageArray
                                            url:nil
                                          title:nil
...
- (void)platShare
{
    ...
    if (imageArray) {
        ...
        [shareParams SSDKSetupSinaWeiboShareParamsByText:@"分享内容 http://www.mob.com/"
                                                   title:nil
...
- (void)screenShare
{
    ...
    [SSEShareHelper screenCaptureShare:^(SSDKImage *image, SSEShareHandler shareHandler) {
        ...
        //构造分享参数
        NSMutableDictionary *shareParams = [NSMutableDictionary dictionary];
        [shareParams SSDKSetupShareParamsByText:@"使用ShareSDK分享，更便捷，更方便。 http://www.mob.com/"
                                         images:@[image]
                                            url:nil
                                          title:nil
                                           type:SSDKContentTypeImage];
...
- (void)oneKeyShare
{
    ...
    if (imageArray)
    {
        ...
        //构造分享参数
        NSMutableDictionary *shareParams = [NSMutableDictionary dictionary];
        [shareParams SSDKSetupShareParamsByText:@"我在使用ShareSDK的一键分享。 http://www.mob.com/"
                                         images:imageArray
                                            url:nil
                                          title:nil
                                           type:SSDKContentTypeImage];
